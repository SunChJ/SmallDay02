...
//  Copyright (c) 2015年 维尼的小熊. All rights reserved.//  探索
...
class ExploreViewController: MainViewController, DoubleTextViewDelegate {
    ...
    private func setNav() {
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "附近", titleClocr: UIColor.blackColor(), targer: self, action: #selector(ExploreViewController.nearClick))
